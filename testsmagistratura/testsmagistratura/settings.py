"""
Django settings for testsmagistratura project.
...
SECRET_KEY = 'django-insecure-0^2$(7ns8)jc$d7ekxuv-c0c^x@@0h_@zux-vo19fi3@*k=0rn'
...
INSTALLED_APPS = [
    ...
    'isviv.apps.IsvivConfig',
    'istgv.apps.IstgvConfig',
    'tosous.apps.TosOusConfig',
    'gidravlika.apps.GidravlikaConfig',
...
ROOT_URLCONF = 'testsmagistratura.urls'
...
WSGI_APPLICATION = 'testsmagistratura.wsgi.application'
